...
describe('FakeServer', function() {
  ...
  describe('Escher authentication', function() {
    it('should use escher authentication', async function() {
      ...
      this.sandbox.stub(Authenticator.prototype, 'authenticate').resolves();
    ...
    it('should return with 401 if escher authentication fails', async function() {
      ...
      this.sandbox.stub(Authenticator.prototype, 'authenticate').rejects(new Error('Signatures do not match'));
  ...
  describe('logging', function () {
    ...
    beforeEach(function() {
      this.sandbox.useFakeTimers(now.getTime());
    });
